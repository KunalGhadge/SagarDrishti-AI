...
- Pick a region (e.g., `us-east-2`)
  - Dev/Test example: `SagarDrishti-AI-dev` (public GET on `uploads/` only if needed)
  - Prod example: `SagarDrishti-AI-prod` (private)
  ...
  "Statement": [
    {
      ...
      "Principal": "*",
      "Action": "s3:GetObject",
      "Resource": "arn:aws:s3:::SagarDrishti-AI-dev/uploads/*"
    }
  ]
}
```
