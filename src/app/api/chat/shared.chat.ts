...
import { createMarineSupervisorTools } from "lib/ai/supervisor/supervisor-orchestrator";

export const loadMarineSupervisorTools = (opt?: {
  dataStream?: UIMessageStreamWriter;
}) =>
  safe(() => createMarineSupervisorTools(opt?.dataStream))
