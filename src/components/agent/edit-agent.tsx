...
import {
  MarineTacticalAnalystExample,
  WeatherExample,
  PFZAdvisorExample,
  MaritimeSafetyOfficerExample,
              ...
              <>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-64" align="end">
                    <DropdownMenuItem
                      onClick={() => setAgent(MarineTacticalAnalystExample)}
                    >
                      <div className="flex items-center gap-2">
                        <span className="text-base">🎯</span>
                        <span className="font-medium">Marine Tactical Analyst</span>
                      </div>
                    </DropdownMenuItem>
                    <DropdownMenuItem
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium">IMD Cyclone Specialist</span>
                      </div>
                    </DropdownMenuItem>
                    <DropdownMenuItem
                      onClick={() => setAgent(PFZAdvisorExample)}
                    >
                      <div className="flex items-center gap-2">
                        <span className="text-base">🛰️</span>
                        <span className="font-medium">INCOIS PFZ Advisor</span>
                      </div>
                    </DropdownMenuItem>
                    <DropdownMenuItem
                      onClick={() => setAgent(MaritimeSafetyOfficerExample)}
                    >
                      <div className="flex items-center gap-2">
                        <span className="text-base">⚓</span>
                        <span className="font-medium">Geospatial Safety Officer</span>
                      </div>
                    </DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
