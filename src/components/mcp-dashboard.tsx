                      ...
                      <div className="flex -space-x-2">
                        {displayIcons.map((mcp, index) => {
                          return (
                            <div
                              key={mcp.name}
                              className="relative rounded-full bg-background border-[1px] p-1 flex items-center justify-center text-xs leading-none"
                              style={{
                  ...
                  <DropdownMenuContent align="end" className="w-64">
                    {RECOMMENDED_MCPS.map((mcp) => {
                      return (
                        ...
                        >
                          <span className="text-base mr-2">{mcp.icon}</span>
                          <span className="truncate">{mcp.label}</span>
                        </DropdownMenuItem>
                      );
                    })}
                  </DropdownMenuContent>
