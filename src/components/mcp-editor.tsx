...
const STDIO_ARGS_ENV_PLACEHOLDER = `/** SagarDrishti Marine MCP Stdio Server */
{
  "command": "python", 
  "args": ["-m", "sagardrishti_marine_mcp"],
  "env": {
    "MOSDAC_API_KEY": "isro-...",
    "IMD_API_KEY": "imd-..."
  }
...
/** SagarDrishti Remote SSE / Streamable HTTP MCP */
{
  "url": "https://marine-mcp.sagardrishti.in/sse",
  "headers": {
    "Authorization": "Bearer sagar_live_..."
  }
}`;
