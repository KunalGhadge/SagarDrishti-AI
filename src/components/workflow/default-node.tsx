      ...
      <ContextMenuTrigger>
        <div
          className={cn(
            ...
            data.runtime?.status === "fail" && "border-destructive ring-2 ring-destructive/40",
            data.runtime?.status === "running" &&
              "border-green-400 ring-2 ring-green-400/50 shadow-lg shadow-green-500/20 animate-pulse",
            data.runtime?.status === "success" && "border-green-400",
          )}
        >
